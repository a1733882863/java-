...
//                    }
//
//                    delField = clazz.getDeclaredField("delFlag");
...
//                    if (currentUser != null && field != null) {
//                        field.setAccessible(true);
//                        field.set(record, currentUser.get("id"));
//                    }
//                } catch (Exception e) {
//
//                }
...
//                    criteria.andLike(filter.getProperty(), "%" + filter.getValue() + "%");
