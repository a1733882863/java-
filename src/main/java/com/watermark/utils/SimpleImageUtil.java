...
public class SimpleImageUtil {
    ...
    public SimpleImageUtil(File file) throws IOException {
    ...
    public SimpleImageUtil(InputStream is) throws IOException {
        processStream(is);
    }

    public SimpleImageUtil(byte[] bytes) throws IOException {
